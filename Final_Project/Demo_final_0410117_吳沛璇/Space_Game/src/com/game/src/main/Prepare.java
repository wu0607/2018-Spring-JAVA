...
public class Prepare {
	...
	public Rectangle one_start = new Rectangle(120, 780, 180, 40);
	public Rectangle two_start = new Rectangle(320, 780, 180, 40);
	...
	public void render(Graphics g) {
		...
		g2d.draw(one_start);
		g2d.draw(two_start);
		g.drawString("Start!", 262, 765);
		g.drawString("One Player", one_start.x+12, one_start.y+29);
		g.drawString("Two Player", two_start.x+12, two_start.y+29);
		//g2d.draw();
